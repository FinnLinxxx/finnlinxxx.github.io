...
Of course [ROS](http://wiki.ros.org/melodic/Installation/Ubuntu) needs to be installed first, be also aware of installing the ros melodic moveit driver beforehand.
